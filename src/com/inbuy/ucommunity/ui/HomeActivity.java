...
public class HomeActivity extends Activity {
	...
	private ArrayList<Category> getCategoryData() {
		...
		int[] nameIds = { R.string.all_merchant, R.string.nearby_merchant,
				R.string.search, R.string.recommand_merchant,
				R.string.popular_merchant, R.string.about };
		int[] logoIds = { R.drawable.ic_launcher, R.drawable.ic_launcher,
