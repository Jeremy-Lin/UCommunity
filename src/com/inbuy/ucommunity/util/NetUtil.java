...
public class NetUtil {
	...
	public static String getCityUrl() {
		...
		sb.append(ACTION_GET_CITY).append(DELIMITER).append(PARAM_NAME_APPKEY)
				.append(DELIMITER).append(APP_KEY).append(DELIMITER)
				.append(PARAM_NAME_APPSECRET).append(DELIMITER)
				.append(APP_SECRET);
